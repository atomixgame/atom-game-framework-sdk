...
import com.jme3.gde.gui.nbeditor.components.toolbar.MainViewToolBar;
...
import com.jme3.gde.gui.palette.nifty.visual.NiftyElementPaletteSupport;
...
public class J2DPreviewToolbarElement extends ToolBarMultiViewElement {
    ...
    public JComponent getToolbarRepresentation() {
        toolBar = new MainViewToolBar(niftyDataObject.getGUIEditor());
