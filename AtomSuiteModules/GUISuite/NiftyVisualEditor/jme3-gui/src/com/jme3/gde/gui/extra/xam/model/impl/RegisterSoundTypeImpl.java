...
/**
 * Implementation for domain component registerSoundType.
 * 
 * @author cuongnguyen
 */
// Generated by XAM AutoGen Tool v0.2
public class RegisterSoundTypeImpl extends NiftyComponentBase implements RegisterSoundType {

    public RegisterSoundTypeImpl(NiftyModel model, Element element) {
        super(model, element);
    }
    
    public RegisterSoundTypeImpl(NiftyModel model) {
        this(model, createElementNS(model, NiftyQName.REGISTERSOUNDTYPE));
    }
