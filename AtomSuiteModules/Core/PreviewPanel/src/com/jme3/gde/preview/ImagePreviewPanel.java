...
public class ImagePreviewPanel extends JPanel
    ...
    public void paintComponent(Graphics g) {
         ...
         * drawing. Also, it seems that the file list can paint outside of its
         * rectangle, and will cause odd behavior if we don't clear or fill the
         * rectangle for the accessory before drawing. This might be a bug in
         * JFileChooser.
         */
