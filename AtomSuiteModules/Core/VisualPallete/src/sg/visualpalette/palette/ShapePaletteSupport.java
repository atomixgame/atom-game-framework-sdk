...
public class ShapePaletteSupport {
    
    public static PaletteController createPalette() {
        AbstractNode paletteRoot = new AbstractNode(Children.create(new CategoryChildFactory(), true));
        paletteRoot.setName("Palette Root");
        return PaletteFactory.createPalette( paletteRoot, new MyActions(), null, new ShapeDnDHandler() );
    }
    ...
    private static class ShapeDnDHandler extends DragAndDropHandler {
        @Override
