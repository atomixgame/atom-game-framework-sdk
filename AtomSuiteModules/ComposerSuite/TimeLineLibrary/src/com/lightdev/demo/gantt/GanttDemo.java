...
/**
 * An application to demonstrate the use of JXTreeTable and JXDatePicker to
 * create a project planning tool implementing an editable gantt chart.
 *
...
public class GanttDemo implements WindowListener, TimeFrameProvider, ActionListener {
     ...
     *
     * <p>This simply sets the system look and feel and then creates a new
     * instance of this application class</p>
     *
     ...
     *
     * <p>This assumes a file named 'license.txt' to exist in the package this
     * class resides in.</p>
     */
