...
/**
 * <p>A drop target for class
 * <code>JXTreeTable</code> that implements autoscrolling, automatic tree node
 * expansion and a custom drag image during the drag part of a drag and drop
 * operation.</p>
 *
 * <p>This class actually is a copy of TreeDropTarget slightly adapted for use
 * with JXTreeTable.</p>
 *
...
public class TreeTableDropTarget extends DropTarget {
     ...
     * constructor
     *
     * @param the transfer handler that provides the drag image for the
    ...
    /**
     * scroll visible tree parts when user drags outside an 'inner part' of the
     * visible region
     */
    ...
    /**
     * paint an insert marker between the nodes closest to the current mouse
     * location
     */
    ...
    /**
     * height of the gap between any two node rows to treat as an area for
     * inserts
     */
    ...
    /**
     * the transfer handler that provides the image for the currently dragged
     * node
     */
