package com.jme3.timeline.components.jaret;
 ...
 */
public class TimelineControlPanel extends JPanel implements ChangeListener, ActionListener {
    ...
    public TimelineControlPanel(TimeBarViewer viewer, TimeBarMarkerImpl marker, boolean hierarchyExampel) {
        _viewer = viewer;
        _marker = marker;
    ...
    private void createControls(boolean hierarchyExample) {
        ...
        /*
         ...
         _freisetzenButton = new JButton(new TrackSelectAction(_viewer.getSelectionModel()));
    ...
    class TrackSelectAction extends AbstractAction implements TimeBarSelectionListener {

        TimeBarSelectionModel _selModel;

        public TrackSelectAction(TimeBarSelectionModel selModel) {
            _selModel = selModel;
    ...
    class FreisetzenDropTargetListener extends DropTargetAdapter {
        ...
        /*
         ...
         TimeLineTrackRow dp1 = (TimeLineTrackRow) o1;
         TimeLineTrackRow dp2 = (TimeLineTrackRow) o2;
