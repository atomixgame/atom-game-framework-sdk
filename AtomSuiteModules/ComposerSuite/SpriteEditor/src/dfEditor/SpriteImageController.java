...
import dfEditor.graphics.PixelPacker;
...
public class SpriteImageController extends dfEditorPanel implements GraphicPanelChangeListener {
    ...
    private dfEditor.components.IntegerTextField textureHeightField;
    private dfEditor.components.IntegerTextField textureWidthField;
    private dfEditor.components.IntegerTextField minSpacingField;
    ...
    public boolean saveCoordsAs() {
        ...
        // FIXME: Remove the direct link please
        mainFrame = dfEditorApp.getApplication().getMainFrame();
    ...
    private boolean saveImageAs() {
        ...
        while (true) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                for (int i = 0; i < supportedFormats.length; ++i) {
                    if (IOUtils.getExtension(f) != null
                            && IOUtils.getExtension(f).equals(supportedFormats[i])) {
    ...
    public boolean load(String aFileName, DefaultTreeModel aModel) {
        ...
        savedImageFormat = dfEditor.io.IOUtils.getExtension(imgFile);
...
//    }
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("dfEditor/resources/SpriteImageController"); // NOI18N
        removeSpriteItem.setText(bundle.getString("removeSpriteItem.text")); // NOI18N
        ...
        addSpriteItem.setText(bundle.getString("addSpriteItem.text")); // NOI18N
        ...
        addDirItem.setText(bundle.getString("addDirItem.text")); // NOI18N
        ...
        removeDirItem.setText(bundle.getString("removeDirItem.text")); // NOI18N
        ...
        addSpriteButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main_icons/Plus.png"))); // NOI18N
        addSpriteButton.setToolTipText(bundle.getString("addSpriteButton.toolTipText")); // NOI18N
        ...
        removeSpriteButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main_icons/Minus.png"))); // NOI18N
        removeSpriteButton.setToolTipText(bundle.getString("removeSpriteButton.toolTipText")); // NOI18N
        ...
        zoomInButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main_icons/ZoomIn.png"))); // NOI18N
        zoomInButton.setToolTipText(bundle.getString("zoomInButton.toolTipText")); // NOI18N
        ...
        zoomOutButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main_icons/ZoomOut.png"))); // NOI18N
        zoomOutButton.setToolTipText(bundle.getString("zoomOutButton.toolTipText")); // NOI18N
        ...
        addFolderButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main_icons/Folder.png"))); // NOI18N
        addFolderButton.setToolTipText(bundle.getString("addFolderButton.toolTipText")); // NOI18N
        ...
        trimButton.setText(bundle.getString("trimButton.text")); // NOI18N
        ...
        untrimButton.setText(bundle.getString("untrimButton.text")); // NOI18N
        ...
        packButton.setText(bundle.getString("packButton.text")); // NOI18N
