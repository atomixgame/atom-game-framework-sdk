 ...
 */
package sg.stac.audio;

import sg.stac.utils.MyByteArrayOutputStream;
...
import sg.stac.audio.AudioUtils.LineAndStream;
import sg.stac.utils.NewDataListener;
import sg.stac.utils.IOUtils;
import sg.stac.utils.ThreadUtils;
...
public class RecordableClip {
    ...
    public RecordableClip(File file) throws IOException, AudioException {
        mFile = file;
        if (!mFile.exists()) {
        ...
        //mFormat = null;
        try {
            mFormat = AudioSystem.getAudioInputStream(file).getFormat();
        } catch (UnsupportedAudioFileException ex) {
            Logger.getLogger(RecordableClip.class.getName()).log(Level.SEVERE, null, ex);
