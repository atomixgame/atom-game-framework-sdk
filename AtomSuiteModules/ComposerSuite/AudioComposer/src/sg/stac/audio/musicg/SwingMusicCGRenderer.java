...
public class SwingMusicCGRenderer {
     ...
     * @see RGB graphic rendered
     */
    public BufferedImage renderSpectrogramData(double[][] spectrogramData) {
                ...
                if (i == xMarker) {
                    ...
                    for (int j = 0; j < height; j++) {
                        ...
                        if (j == yMarker) {
                            ...
                            double sv =spectrogramData[i][j];
                            //value = 255 - (int) ( * 255);
                            value=colorMap.getColorByValue((float)sv).getRGB();
                        }
