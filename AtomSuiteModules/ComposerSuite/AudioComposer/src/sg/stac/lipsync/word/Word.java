...
import sg.stac.lipsync.FacePanel;
...
public class Word extends TextChunk {
    ...
    public void move(int newStart, int newEnd, int hitPart) {
        ...
        switch (hitPart) {
            ...
            case DopeSheet.HIT_MIDDLE:
                ...
                waveManager.playFrames(newStart, newStart, newStart);
                break;
            case DopeSheet.HIT_BACK:
                // play the wave from the front
                waveManager.stopPlayingWave();
                waveManager.playFrames(newEnd, newEnd, newEnd);
                break;
        }
        // adjust children?
        if (resized) {
    ...
    public void readXml(SimpleXmlReader xmlReader) throws IOException {
    ...
    public void writeXml(FileWriter stream) throws IOException {
        stream.write("<word>\n");
        // sentance information
