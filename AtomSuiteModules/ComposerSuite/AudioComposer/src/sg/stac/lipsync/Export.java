...
public class Export {
    ...
    public static final String createContents(int fileFormat) {
        ...
        int frameCount = LipSyncMainApp.mainWindow.dopeSheet.waveFile.frameCount;
        int framesPerSecond = LipSyncMainApp.mainWindow.dopeSheet.waveFile.framesPerSecond;

        // create a timeline of phonemes
        String[] phonemeTimeline = LipSyncMainApp.mainWindow.dopeSheet.buildFaceNameTimeline();

        // create a timeline of words
        String[] wordTimeline = LipSyncMainApp.mainWindow.dopeSheet.buildWordTimeline();
