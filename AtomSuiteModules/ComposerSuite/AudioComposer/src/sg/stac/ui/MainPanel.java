 ...
 *
 * Fefie.com Sound Recorder is free software; you can redistribute it and/or
...
import sg.stac.audio.AudioUtils;
import sg.stac.audio.RecordableClip;
import sg.stac.utils.SwingUtils;

/**
 * Panel that uses the library to implement a "sound recorder" application that
 * loads and saves sound files.
 *
 * @author stefie10
 *
 */
