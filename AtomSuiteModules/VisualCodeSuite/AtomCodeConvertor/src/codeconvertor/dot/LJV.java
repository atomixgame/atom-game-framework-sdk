...
class LJV {
    ...
    /* === SETUP BEGINS HERE === */
    /**
     * Set this to the path of the DOT executable from the Graphviz package that
     * you downloaded and installed earlier. You may not need to do this if you
     * updated your PATH with the Graphviz bin directory.
     */
    ...
    static class Context {
        ...
        /**
         * Set the DOT output file format. E.g., <tt>ps</tt> for PostScript,
         * <tt>png</tt> for PNG, etc.
         */
         ...
         *
       If non-null, the DOT file is left in this file. This is only really
         * useful for debugging Graphviz.java.<p/>
         */
        public String keepDotFile = null;

        /**
         * Set the DOT attributes for a class. This allows you to change the
         * appearance of certain nodes in the output, but requires that you know
         * something about dot attributes. Simple attributes are, e.g.,
         * "color=red".
         */
         ...
         * that you know something about dot attributes. Simple attributes are,
         * e.g., "color=blue".
         */
         ...
         * <code>toString</code> is called on the object, and the result
         * displayed in the label like a primitive field.
         */
        ...
        /**
         * Allow private, protected and package-access fields to be shown. This
         * is only possible if the security manager allows
         * <code>ReflectPermission("suppressAccessChecks")</code> permission.
         * This is usually the case when running from an application, but not
         * from an applet or servlet.
         */
        public boolean ignorePrivateFields = false;
        /**
         * Toggle whether or not to include the field name in the label for an
         * object. This is currently all-or-nothing. TODO: allow this to be set
         * on a per-class basis.
         */
        public boolean showFieldNamesInLabels = true;
        /**
         * Toggle whether to display the class name in the label for an object
         * (false, the default) or to use the result of calling toString (true).
         */
        //public boolean useToStringAsClassName = false;
        /**
         * Toggle whether to display qualified nested class names in the label
         * for an object from the same package as LJV (true) or to display an
    ...
    private static boolean fieldExistsAndIsPrimitive(Context ctx, Field field, Object obj) {
        if (!ctx.canIgnoreField(field)) {
            try {
                ...
                if (field.getType().isPrimitive() || ctx.canTreatAsPrimitive(val)) //- Just calling ctx.canTreatAsPrimitive is not adequate --
    ...
    protected static void processFields(Context ctx, Object obj, Field[] fs, PrintWriter out, Set visited) {
        for (int i = 0; i < fs.length; i++) {
            ...
            if (!ctx.canIgnoreField(field)) {
                try {
                    Object ref = field.get(obj);
                    if (field.getType().isPrimitive() || ctx.canTreatAsPrimitive(ref)) //- The field might be declared, say, Object, but the actual
    ...
    /**
     * Write a DOT digraph specification of the graph rooted at <tt>obj</tt> to
     * <tt>out</tt>.
     */
