package sg.atom.visualcode.palette;
...
public class ShapeChildFactory extends ChildFactory<Shape> {
    ...
    protected boolean createKeys(List<Shape> list) {
        list.add(new Shape(0, category.getName(), "sg/atom/visualcode/palette/image1.png"));
        list.add(new Shape(1, category.getName(), "sg/atom/visualcode/palette/image2.png"));
        list.add(new Shape(2, category.getName(), "sg/atom/visualcode/palette/image3.png"));
        return true;
    }
