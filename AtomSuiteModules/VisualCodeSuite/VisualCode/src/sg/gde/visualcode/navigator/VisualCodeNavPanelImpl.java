package sg.gde.visualcode.navigator;
...
import sg.gde.visualcode.presentation.nodes.VisualCodeDocNode;

/**
 * Basic dummy implementation of NavigatorPanel interface.
 *
 * FIXME: Replace with NavigatorPanel.Registration
 */
public class VisualCodeNavPanelImpl extends JPanel implements NavigatorPanel, ExplorerManager.Provider {
     ...
     */
    private static final Lookup.Template MY_DATA = new Lookup.Template(VisualCodeDocNode.class);
    /**
    ...
    private VisualCodeFileDataObject VisualCodeObject;
    //private VisualCode VisualCode;
    JToolBar toolbar;
    private Document doc;
    //private VisualCodeDocNode rootContext;

    /**
     * public no arg constructor needed for system to instantiate provider well
     */
    public VisualCodeNavPanelImpl() {
    ...
    public String getDisplayHint() {
        return " VisualCode Navigator Panel ";
    }

    public String getDisplayName() {
        return "VisualCode Outline View";
    }
    ...
    public void loadNodes(VisualCodeFileDataObject visualCodeObject) {
        //manager.setRootContext(VisualCodeObject.getGUIEditor().getRootContext());
    }
    ...
    private void setNewContent(final Collection newData) {
        ...
        if (!newData.isEmpty()) {
            //VisualCodeObject = (VisualCodeGuiDataObject) newData.iterator().next();
//            rootContext = (VisualCodeDocNode) newData.iterator().next();
