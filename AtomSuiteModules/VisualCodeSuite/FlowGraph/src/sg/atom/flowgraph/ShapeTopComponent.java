...
import sg.atom.flowgraph.graph.GraphSceneImpl;
import sg.atom.flowgraph.palette.PaletteSupport;

@ConvertAsProperties(dtd = "-//sg.atom.flowgraph//Shape//EN",
autostore = false)
@TopComponent.Description(preferredID = "ShapeTopComponent",
//iconBase="SET/PATH/TO/ICON/HERE", 
persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = true)
@ActionID(category = "Window", id = "sg.atom.flowgraph.ShapeTopComponent")
